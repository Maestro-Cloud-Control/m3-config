...
request_to_lm() { curl -sf -X POST -H "Content-Type: application/json" -d "{\"signature\":\"$(document_signature)\",\"document\":\"$(identity_document | base64 -w 0)\"}" "$LM_API_LINK/marketplace/maestro/init"; }
